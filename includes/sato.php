<div class="tm-top-a-box tm-full-width tm-box-bg-1 ">
  ...
  <table class="table table-condensed table-bordered">
    ...
    <tbody class="table-hover">
    	<tr>
        <td><a href="profile">Profile<span class="glyphicon glyphicon-home pull-right"></span></a> </td>
      ...
      <tr>
        <td><a href="Branches">Our Branches<span class="glyphicon glyphicon-home pull-right"></span></a> </td>
        ...
        $pending = mysqli_query($conn,$query);
          ...
          ?>
       			...
       			<div class="col-sm-9">
       				...
       				<h3><?php echo strtoupper($_SESSION["loggedInUser"]);?> <span class="pull-right" >Your Balance is  ₦
              <?php 
              $am ="{$row['amount']}";
