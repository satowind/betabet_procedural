...
?>
    ...
    if( mysqli_num_rows($result) > 0 ) {
        ...
        while( $row = mysqli_fetch_assoc($result) ) {
            ...
            echo" <td> ".$row['name']."</td><td>" . $row['address'] . "</td><td>" . $row['state'] . "</td><td>" . $row['lga'] . "</td><td>" . $row['city'] . "</td><td>" . $row['phone'] . "</td><td>" . $row['email'] . "</td>";
            
           
            
            echo '<td><a  href="edit_headoffice?id=' . $row['id'] . '" type="button" class="btn btn-primary btn-sm pull-right">Update
        ...
        echo "<div class='alert alert-warning'>You have no Head Office!</div>";
    }
    ...
    ?>
        ...
        <div>
             <td colspan="4"><div class="text-center"><a href="add_headoffice" type="button" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> Add Post</a></div></td>
        </div>
