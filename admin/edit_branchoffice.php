...
if( isset($_POST['update']) ) {
    ...
    if( $result ) {
        ...
        header("Location: branch_office?alert=updatesuccess");
    } else {
...
if( isset($_POST['confirm-delete']) ) {
    ...
    if( $result ) {
        ...
        // redirect to client page with query string
        header("Location: branch_office?alert=deleted");
    } else {
        echo "Error updating record: " . mysqli_error($conn);
    }
   ...
   <div class="col-sm-12" id="all" style="display:none">
    <div class="form-group ">
       ...
       <div class="form-group">  
        ...
        <input type="text" class="form-control input-lg" id="client-name" name="id" value="<?php echo $id; ?>">
      </div>
      <div class="form-group">  
        ...
        <input type="text" class="form-control input-lg" id="client-name" name="code" value="<?php echo $code; ?>">
      </div>
       <div class="form-group">  
