...
// query & result
$query = "SELECT * FROM transactiontable WHERE Report=2 ORDER BY `date` DESC";
        ...
        <script >
            ...
            $('.done').click(function(e){
                ...
                if(id){
                    ...
                    $.get("setDoneWithdraw.php?id="+id+"&action=withdraw&user="+user+"&amount="+amount,function(res){
                        console.log(res);
                        if(res.success){
