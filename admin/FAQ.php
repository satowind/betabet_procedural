...
if( isset( $_GET['alert'] ) ) {
    ...
    if( $_GET['alert'] == 'success' ) {
        $alertMessage = "<div class='alert alert-success'>New FAQ added! <a class='close' data-dismiss='alert'>&times;</a></div>";
...
?>
    ...
    if( mysqli_num_rows($result) > 0 ) {
        ...
        while( $row = mysqli_fetch_assoc($result) ) {
            ...
            echo" <td>" . $row['Question'] . "</td><td>" . $row['Reply'] . "</td>";
            
           
            
            echo '<td><a  href="editFAQ?id=' . $row['id'] . '" type="button" class="btn btn-primary btn-sm pull-right">Update
    ...
    ?>
        ...
        <div>
             <td colspan="4"><div class="text-center"><a href="addFAQ" type="button" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> Add Post</a></div></td>
        </div>
