...
if( isset( $_GET['alert'] ) ) {
    ...
    // client updated
        ...
        $alertMessage = "<div class='alert alert-success'>How to updated! <a class='close' data-dismiss='alert'>&times;</a></div>";
    
    // client deleted
    } elseif( $_GET['alert'] == 'deleted' ) {
        $alertMessage = "<div class='alert alert-success'>How to deleted! <a class='close' data-dismiss='alert'>&times;</a></div>";
    }
...
?>
    ...
    if( mysqli_num_rows($result) > 0 ) {
        ...
        while( $rowss = mysqli_fetch_assoc($result) ) {
            ...
            echo" <td> ".$rowss['aboutUs']."</td>";
            
           
            
            echo '<td><a  href="edithowto?id=' . $rowss['id'] . '" type="button" class="btn btn-primary btn-sm done">
                   Edit
                    </a></td>';
