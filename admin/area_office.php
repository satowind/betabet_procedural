...
?>
    ...
    if( mysqli_num_rows($result) > 0 ) {
        ...
        while( $row = mysqli_fetch_assoc($result) ) {
            ...
            echo '<td><a  href="edit_areaoffice?id=' . $row['id'] . '" type="button" class="btn btn-primary btn-sm pull-right">Update
    ...
    ?>
        ...
        <div>
             <td colspan="4"><div class="text-center"><a href="add_areaoffice" type="button" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> Add Post</a></div></td>
        </div>
