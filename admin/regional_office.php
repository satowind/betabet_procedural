...
// query & result
$query = "SELECT * FROM branch WHERE hierachy= 'regional office'";
...
?>
    ...
    if( mysqli_num_rows($result) > 0 ) {
        ...
        while( $row = mysqli_fetch_assoc($result) ) {
            ...
            echo '<td><a  href="edit_regionaloffice?id=' . $row['id'] . '" type="button" class="btn btn-primary btn-sm pull-right">Update
        ...
        echo "<div class='alert alert-warning'>You have no Regional Office!</div>";
    }
    ...
    ?>
        ...
        <div>
             <td colspan="4"><div class="text-center"><a href="add_regionaloffice" type="button" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> Add Post</a></div></td>
        </div>
