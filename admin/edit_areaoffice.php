...
if( isset($_POST['update']) ) {
    ...
    if( $result ) {
        ...
        header("Location: area_office?alert=updatesuccess");
    } else {
...
if( isset($_POST['confirm-delete']) ) {
    ...
    if( $result ) {
        ...
        // redirect to client page with query string
        header("Location: area_office?alert=deleted");
    } else {
        echo "Error updating record: " . mysqli_error($conn);
    }
   ...
   <label for="client-email"><h3 class="h3 text-danger">Local Government</h3></label> 
    ...
    <div class="col-sm-12">
        ...
        <div class="pull-right">
            ...
            <a href="area_office" type="button" class="btn btn-lg btn-primary">Cancel</a>
