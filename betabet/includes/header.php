        ...
        <div class="tm-menu-box">
            ...
            <div style="height: 70px;" class="uk-sticky-placeholder">
                <nav style="margin: 0px;" class="tm-navbar uk-navbar" data-uk-sticky="">
                    <div  class="uk-container uk-container-center">
                        <a class="tm-logo uk-float-left" href="index">
                             <img src="images/logo-loader.png" alt="logo" title="logo"> <span>Beta<em> Bet</em></span>
                        </a>

                        <ul class="uk-navbar-nav uk-hidden-small">
                            
                            <li data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="../index">CityCyber</a></li>
                ...
                ?>
                            ...
                            <li><a class="sa_side border_to_forestgreen to_forestgreen" href="index">Login/Register</a></li>
